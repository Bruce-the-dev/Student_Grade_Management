...
public class Main {
    ...
    private static void viewStudentsMenu() {
        ...
        for (int i = 0; i < studentManager.getStudentCount(); i++) {
            ...
            if (student != null) {
                ...
                // Print second line: additional details
                ...
                // If Honors student, check eligibility
    ...
    private static void addInitialGrades(String studentId, double targetAverage, int numSubjects) {
        Subject[] subjects = {
        ...
        // For the first (numSubjects - 1) subjects:
        ...
        // Last grade — makes the total average EXACT
        double lastGrade = totalNeeded - sum;

        // Clamp to range 0–100 (just in case)
        lastGrade = Math.max(0, Math.min(100, lastGrade));
